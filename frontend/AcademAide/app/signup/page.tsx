                    ...
                    <CardContent className="grid gap-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="grid gap-2">
                                ...
                                <Input id="first-name" placeholder="Max" required className="bg-white/50 border-gray-200 focus:border-primary/50 focus:ring-primary/20 dark:bg-slate-950/50 dark:border-slate-800" />
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="last-name">Last name</Label>
                                <Input id="last-name" placeholder="Robinson" required className="bg-white/50 border-gray-200 focus:border-primary/50 focus:ring-primary/20 dark:bg-slate-950/50 dark:border-slate-800" />
                            </div>
                        </div>
                        <div className="grid gap-2">
                            <Label htmlFor="email">Email</Label>
                            <Input id="email" type="email" placeholder="m@example.com" required className="bg-white/50 border-gray-200 focus:border-primary/50 focus:ring-primary/20 dark:bg-slate-950/50 dark:border-slate-800" />
                        </div>
                        <div className="grid gap-2">
                            <Label htmlFor="password">Password</Label>
                            <Input id="password" type="password" required className="bg-white/50 border-gray-200 focus:border-primary/50 focus:ring-primary/20 dark:bg-slate-950/50 dark:border-slate-800" />
                        </div>
                    </CardContent>
