...
export function Sidebar() {
    ...
    return (
        <div className="flex h-full w-64 flex-col border-r bg-white/50 backdrop-blur-xl dark:bg-slate-900/50 dark:border-white/10 text-card-foreground">
                        ...
                        <Link
                            ...
                            className={cn(
                                ...
                                pathname === item.href
                                    ...
                                    : "text-muted-foreground hover:bg-white hover:text-indigo-600 dark:hover:bg-white/10 dark:hover:text-indigo-300"
                            )}
                        >
